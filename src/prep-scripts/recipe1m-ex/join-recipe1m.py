...
def run(args):
    ...
    tags = json.load(open(args.tags, "r", encoding="latin-1"))
...
parser = argparse.ArgumentParser(description="Joins recipe1m data with scraped tags")
...
parser.add_argument("tags", help="tags.json generated from scraped data")
